...
group.add_argument('--load-in-4bit', action='store_true', default=False, help='boolean value, True means loading the model to symmetric int4 precision if'
                   'it is a regular fp16/bf16/fp32 model, and to asymmetric int4 precision if it is GPTQ model. Default to be False')
